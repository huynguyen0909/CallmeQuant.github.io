...
&\prop \theta^{n_1 + \alpha - 1} (1-\theta)^{n_2 + \beta - 1}
\end{align}
$$
...
$$\mathop{\rm argmax}\limits_{\theta} \left[ \lambda^{n_1 + \alpha - 1} ( 1- \lambda)^{n_2 + \beta - 1} \right] \quad \tag(5)$$
...
---
<img src="/assets/images/2023-10-09-MAP_files/Beta dist plot.png">
---
